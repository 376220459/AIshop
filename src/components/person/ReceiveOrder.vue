<template>
    <div class="receive-order-whole" :style="{right:wholeRight+'%'}">
        <header>
            <i class="iconfont icon-fanhui1" @click="goBack"></i>
            <p>我的订单</p>
        </header>

        <div class="receive-order-nav">
            <span @click="goOrder('whole-order')">全部</span>
            <span @click="goOrder('pay-order')">待付款</span>
            <span>待收货</span>
            <span @click="goOrder('finish-order')">已完成</span>
        </div>

        <div class="receive-order-content">
            <ul>
